...
ConfigurationManager.ConnectionStrings[1].ConnectionString;
        ...
        private void Inserir(string companyName, string phone)
        {
        ...
        private void Excluir(int Codigo)
        {
            ...
            string sql = "DELETE FROM Shippers WHERE ShipperID = @Codigo";
        ...
        private void Atualizar(int codigo, string companyName, string phone)
        {
            // Comando SQL para inserir um novo Shipper
            string sql = "UPDATE Shippers SET CompanyName = @CompanyName, Phone = @Phone WHERE ShipperId = @Codigo";
