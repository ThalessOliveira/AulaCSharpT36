...
namespace T36_ProjetoBase
{
    public partial class frmPrincipal : Form
    {
        ...
        private void ntw02ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmNtw02 tela02 = new frmNtw02();
            tela02.StartPosition = FormStartPosition.CenterScreen;
            tela02.ShowDialog();
        }

        private void ntw03ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmNtw03 tela03 = new frmNtw03();
            tela03.StartPosition = FormStartPosition.CenterScreen;
            tela03.ShowDialog();
        }
    }
}
